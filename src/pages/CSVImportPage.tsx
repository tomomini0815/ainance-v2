            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold text-text-main">CSVインポート・エクスポート</h1>
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <button
                            ...
                            className="flex-1 md:flex-none flex items-center justify-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20 text-sm whitespace-nowrap"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 md:flex-none flex items-center justify-center px-4 py-2 bg-surface border border-border rounded-lg hover:bg-border/50 transition-colors text-sm whitespace-nowrap"
                        >

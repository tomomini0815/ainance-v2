import{d as xe,a as me,u as he,b as pe,r as p,j as e,L as k,F as f,P as _,S as F,R as ue,e as b,C as U,m as be,f as ge}from"./index-CWiOvhzK.js";import{D as fe}from"./DepreciationCalculator-dkE26Xeq.js";import{g as je,c as Ne,f as c,A as Y,a as ve,b as ye}from"./TaxFilingService-DDB1LB_S.js";import{g as we,a as ke,d as Ce}from"./eTaxExportService-DEuuuqQn.js";import{d as C,p as I}from"./pdfAutoFillService-BPPs5-0M.js";import{g as Ie,a as De,b as Fe,c as Se}from"./pdfJapaneseService-BTPZ6FzI.js";import{A as H}from"./arrow-left-CLvS8XIA.js";import{C as O}from"./calculator-B2MV3Ezg.js";import{D as j}from"./download-DZITA0YY.js";import{A as $e}from"./arrow-right-2oyTe7wf.js";import{C as W}from"./circle-check-big-CPubxLkl.js";import{C as g}from"./copy-BWMlKzv9.js";import{E as $}from"./external-link-C-QDWrvD.js";import{R as _e}from"./refresh-cw-08Atg-6j.js";import{I as Ae}from"./info-9oRgKXhK.js";import"./CorporateTaxService-BJ2xCYBe.js";import"./circle-question-mark-DsmxZMiW.js";/**
 * @license lucide-react v0.540.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Re=[["path",{d:"M10 12.5 8 15l2 2.5",key:"1tg20x"}],["path",{d:"m14 12.5 2 2.5-2 2.5",key:"yinavb"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z",key:"1mlx9k"}]],Pe=xe("file-code",Re),D=[{id:1,title:"基本情報",icon:f,description:"申告の基本設定"},{id:2,title:"収支確認",icon:O,description:"売上・経費の確認"},{id:3,title:"減価償却",icon:O,description:"固定資産の償却計算"},{id:4,title:"控除入力",icon:_,description:"各種控除の入力"},{id:5,title:"AI診断",icon:F,description:"AIによる節税アドバイス"},{id:6,title:"申告書作成",icon:j,description:"PDFダウンロード"}],Qe=()=>{const{user:u}=me(),{currentBusinessType:a}=he(),N=(a==null?void 0:a.business_type)==="corporation",{transactions:A}=pe(u==null?void 0:u.id,a==null?void 0:a.business_type),[x,R]=p.useState(1),[P,E]=p.useState(!1),v=new Date().getFullYear(),[i,J]=p.useState(v-1),[m,L]=p.useState(!0),[h,y]=p.useState([]),[z,V]=p.useState([]),[M,q]=p.useState(0),[w,G]=p.useState(0);p.useEffect(()=>{y(je(m))},[m]);const s=p.useMemo(()=>{const t=Ne(A,i,(a==null?void 0:a.business_type)||"individual",h);return{...t,totalExpenses:t.totalExpenses+w,netIncome:t.netIncome-w,taxableIncome:Math.max(0,t.taxableIncome-w)}},[A,i,a,h,w]),K=()=>{x<D.length&&R(x+1)},Z=()=>{x>1&&R(x-1)},Q=t=>{const n=Y.find(o=>o.type===t);n&&!h.find(o=>o.type===t)&&y([...h,{id:Date.now().toString(),...n,amount:0,isApplicable:!0}])},B=t=>{y(h.filter(n=>n.id!==t))},ee=(t,n)=>{y(h.map(o=>o.id===t?{...o,amount:n}:o))},te=async()=>{E(!0);try{const t=await ye(s,{});V(t.suggestions),q(t.estimatedSavings)}catch(t){console.error("AI診断エラー:",t)}finally{E(!1)}},X=()=>{const t=`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
           ${N?"法人税申告書":"確定申告書"}（${i}年度）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

import{s as S,d as C}from"./keywordCategoryService-CJZC7PeS.js";const $="your_gemini_api_key_here",I=["gemini-2.0-flash","gemini-2.0-flash-lite","gemini-1.5-flash","gemini-1.5-pro"],x=`https://generativelanguage.googleapis.com/v1beta/models/${I[0]}:generateContent`,O=t=>`https://generativelanguage.googleapis.com/v1beta/models/${t}:generateContent`;async function w(t,y){var l,g,p,m,u;const c=`あなたは日本の経理・会計の専門家です。以下のレシートのOCRテキストを分析し、JSON形式で情報を抽出してください。

    ...
    <div className="min-h-screen bg-background">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-text-main">申告書一覧</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="flex items-end space-x-2">
              <button
                ...
                className="flex-1 btn-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
                検索
              </button>
              <button
        ...
        {favoriteDocuments.length > 0 && (
          <div className="bg-surface rounded-xl shadow-sm border border-border p-6">
            <h2 className="text-lg font-medium text-text-main mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {taxDocuments
                ...
                .map((document) => (
                  <div key={document.id} className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow bg-surface">
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="font-medium text-text-main">{document.document_type}</h3>

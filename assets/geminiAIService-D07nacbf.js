import{s as A,d as C}from"./keywordCategoryService-9yZ-pShI.js";const $="***REMOVED_API_KEY***",D=!0,x=["gemini-2.0-flash","gemini-1.5-flash-latest","gemini-1.5-pro-latest","gemini-flash-latest","gemini-pro-latest"],N=`https://generativelanguage.googleapis.com/v1beta/models/${x[0]}:generateContent`,E=r=>`https://generativelanguage.googleapis.com/v1beta/models/${r}:generateContent`;async function k(r,t){var f,p,y,o,w,l,d,n;const e=new Date().toISOString().split("T")[0],_=new Date().getFullYear(),g=`あなたは「CLOVA OCR」のような最高峰の日本語レシート認識エンジンをシミュレートするAIです。

...
const BusinessTypeSwitcher: React.FC<BusinessTypeSwitcherProps> = ({
  ...
  // showCreateModal state is removed as it's now handled by parent via onCreateClick
        ...
        <button
          onClick={() => {
            if (onCreateClick) {
              ...
              console.warn('onCreateClick prop provided to BusinessTypeSwitcher is undefined')
              // Fallback or alert? The plan implies we use the prop.
            }
            setShowDropdown(false)
          }}

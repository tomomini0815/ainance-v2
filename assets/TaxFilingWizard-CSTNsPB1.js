import{c as ie,a as ce,b as oe,d as de,r as b,j as e,L as C,F as v,P as T,S as A,R as xe,g as f,t as me,T as pe}from"./index-BoVDatVZ.js";import{g as he,c as ue,f as d,A as U,a as be,b as ge}from"./TaxFilingService-DDB1LB_S.js";import{g as je,d as $,p as I,a as fe,b as Ne,c as ye}from"./pdfAutoFillService-CLA7LvWZ.js";import{A as z}from"./arrow-left-BUu2Torr.js";import{C as ve}from"./calculator-C3m-DP-t.js";import{D as w}from"./download-mSXCGWdv.js";import{A as we}from"./arrow-right-DZLW0bf2.js";import{C as M}from"./circle-check-big-UNgSMYYS.js";import{C as y}from"./copy-BlNhYUxQ.js";import{E as R}from"./external-link-BEcXKPJV.js";import{C as X}from"./circle-alert-CatGLfLZ.js";import{R as ke}from"./refresh-cw-BrrIU8gW.js";import{I as Ce}from"./info-B-M-lgQy.js";/**
...
`)}
  ...
  <差引金額>${n.netIncome}</差引金額>
</収支内訳書>`}function Fe(n,a){const j=new Blob(["\uFEFF"+n],{type:"application/xml;charset=utf-8"}),o=URL.createObjectURL(j),u=document.createElement("a");u.href=o,u.download=a,document.body.appendChild(u),u.click(),document.body.removeChild(u),setTimeout(()=>URL.revokeObjectURL(o),1e3)}const D=[{id:1,title:"基本情報",icon:v,description:"確定申告の基本設定"},{id:2,title:"収支確認",icon:ve,description:"売上・経費の確認"},{id:3,title:"控除入力",icon:T,description:"各種控除の入力"},{id:4,title:"AI診断",icon:A,description:"AIによる節税アドバイス"},{id:5,title:"申告書作成",icon:w,description:"PDFダウンロード"}],Oe=()=>{const{user:n}=ce(),{currentBusinessType:a}=oe(),{transactions:j}=de(n==null?void 0:n.id,a==null?void 0:a.business_type),[o,u]=b.useState(1),[F,g]=b.useState(!1),N=new Date().getFullYear(),[r,Y]=b.useState(N-1),[p,P]=b.useState(!0),[h,k]=b.useState([]),[_,O]=b.useState([]),[E,H]=b.useState(0);b.useEffect(()=>{k(he(p))},[p]);const s=b.useMemo(()=>ue(j,r,(a==null?void 0:a.business_type)||"individual",h),[j,r,a,h]),J=()=>{o<D.length&&u(o+1)},W=()=>{o>1&&u(o-1)},V=t=>{const l=U.find(x=>x.type===t);l&&!h.find(x=>x.type===t)&&k([...h,{id:Date.now().toString(),...l,amount:0,isApplicable:!0}])},q=t=>{k(h.filter(l=>l.id!==t))},G=(t,l)=>{k(h.map(x=>x.id===t?{...x,amount:l}:x))},K=async()=>{g(!0);try{const t=await ge(s,{});O(t.suggestions),H(t.estimatedSavings)}catch(t){console.error("AI診断エラー:",t)}finally{g(!1)}},L=()=>{const t=`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
           確定申告書（${r}年度）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

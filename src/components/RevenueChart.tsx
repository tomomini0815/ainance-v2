      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="card-metric border-l-secondary bg-surface p-4 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs text-success flex items-center gap-1 ml-auto sm:hidden">
              <span>↑</span> 12.5% vs 先月
            </p>
          </div>
          <p className="text-xl font-bold text-text-main">¥{totalRevenue.toLocaleString()}</p>
          <p className="text-xs text-success flex items-center gap-1 hidden sm:block">
            <span>↑</span> 12.5% vs 先月
          </p>
        </div>
        <div className="card-metric border-l-accent bg-surface p-4 rounded-xl">
          ...
          <p className="text-xl font-bold text-text-main">¥{totalExpense.toLocaleString()}</p>
          <p className="text-xs text-success flex items-center gap-1 hidden sm:block">
            <span>↓</span> 3.2% vs 先月
          </p>
        </div>
        <div className="card-metric border-l-success bg-surface p-4 rounded-xl">
          ...
          <p className="text-xl font-bold text-text-main">¥{totalProfit.toLocaleString()}</p>
          <p className="text-xs text-success flex items-center gap-1 hidden sm:block">
            <span>↑</span> 8.7% vs 先月
          </p>
        </div>

import{r as N,j as s,S as F,X as ye,C as X,x as Te,d as Ae,_ as De,a as Me,q as Le,h as $e,L as ke,f as Q,T as Ge,F as Ue}from"./index-CebbpuON.js";import{g as Fe}from"./pdfJapaneseService-DxcLygp4.js";import{g as J}from"./motion-l4HYIiXz.js";import{A as qe}from"./index-DvU3lfrl.js";import{I as V}from"./info-D-mtXWK-.js";import{A as He}from"./arrow-left-C0RUcuZD.js";import{J as Pe}from"./japanese-yen-CH5sgNV3.js";import{D as Z}from"./download-D_Dyw1oO.js";import{C as Ye}from"./clock-DgDpRAU9.js";import{T as Be}from"./trophy-Di0OmQAK.js";import{L as Ke}from"./lightbulb-RxLGP0cj.js";import{C as Je}from"./circle-check-big-D4HPafRK.js";var ee;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(ee||(ee={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],pt={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function bt(e){let t=!1;for(const n of e){const{role:i,parts:r}=n;if(!t&&i!=="user")throw new C(`First content should be with role 'user', got ${i}`);if(!ne.includes(i))throw new C(`Each item should include role field. Got ${i} but valid roles are: ${JSON.stringify(ne)}`);if(!Array.isArray(r))throw new C("Content should have 'parts' property with an array of Parts");if(r.length===0)throw new C("Each Content should have at least one part");const a={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(const l of r)for(const u of xe)u in l&&(a[u]+=1);const o=pt[i];for(const l of xe)if(!o.includes(l)&&a[l]>0)throw new C(`Content with role '${i}' can't contain '${l}' part`);t=!0}}function fe(e){var t;if(e.candidates===void 0||e.candidates.length===0)return!1;const n=(t=e.candidates[0])===null||t===void 0?void 0:t.content;if(n===void 0||n.parts===void 0||n.parts.length===0)return!1;for(const i of n.parts)if(i===void 0||Object.keys(i).length===0||i.text!==void 0&&i.text==="")return!1;return!0}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

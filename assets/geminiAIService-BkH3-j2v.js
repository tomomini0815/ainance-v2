import{s as A,d as C}from"./keywordCategoryService-CeSB7JfV.js";const $="AIzaSyDblpyTocM3dVlR9EpbsML9JhjjFIZlndw",D=!0,x=["gemini-2.0-flash","gemini-2.5-flash","gemini-2.5-pro","gemini-flash-latest","gemini-pro-latest"],N=`https://generativelanguage.googleapis.com/v1beta/models/${x[0]}:generateContent`,E=r=>`https://generativelanguage.googleapis.com/v1beta/models/${r}:generateContent`;async function k(r,e){var f,d,_,a,b,c,y,n;const t=new Date().toISOString().split("T")[0],p=new Date().getFullYear(),w=`あなたは「CLOVA OCR」のような最高峰の日本語レシート認識エンジンをシミュレートするAIです。
